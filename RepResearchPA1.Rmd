...
`r maxInterval`.  The maximum of average steps in the data was `r maxSteps`
...
After imputting NAs, **mean** number of steps taken per day = `r mean.imp`  
After imputing NAs, **median** number of steps taken per day = `r median.imp`
