...
**`r maxInterval`**.  
The maximum of average steps in the data was **`r maxSteps`**
...
One interesting observation that can be quickly made from the above panel plots is that it appears the subject typically sleeps in on weekends.